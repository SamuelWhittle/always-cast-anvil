...
local mod_id = "always-cast-anvil" -- This should match the name of your mod's folder.
mod_settings_version = 1 -- This is a magic global that can be used to migrate settings to new mod versions. call mod_settings_get_version() before mod_settings_update() to get the old value. 
mod_settings = 
{
	{
        id = "reforge_behavior",
        ui_name = "Reforge Behavior",
        ui_description = "How do you want the anvil to handle wands with always cast?",
        value_default = "spell",
        values = { {"spell","Give Spell"}, {"wand","Give Wand"}, {"random","Pick randomly"} },
